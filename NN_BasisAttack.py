...
np.save('l2_error_MSB_BasisAtack_8p3.npy',l2_error_MSB)
np.save('l2_error_MSBm1_BasisAtack_8p3.npy',l2_error_MSBm1)
np.save('inference_accuracy_BasisAtack_8p3.npy',accuracy_reconstructed_unscaledflat)
np.save('mismatch_prob_BasisAtack_8p3.npy',mismatch_prob)

#%%       
l2_error_MSB = np.load('l2_error_MSB_BasisAtack_8p3.npy')
loc_idx = 0
ftsize = 15
...
#%%      
l2_error_MSBm1 = np.load('l2_error_MSBm1_BasisAtack_8p3.npy') 
loc_idx = 0
ftsize = 15
fig, ax = plt.subplots(figsize = FIG_SIZE)
ax.grid(which = 'both', alpha = GRID_ALPHA, linestyle = 'dotted')
