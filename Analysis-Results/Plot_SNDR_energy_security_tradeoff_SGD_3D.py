...
inference_accuacy_SGD_8p3 = np.load('inference_accuracy_SGD_8p3.npy')
inference_accuacy_SGD_8p3_max = np.max(inference_accuacy_SGD_8p3[:,:NI],axis=1)
inference_accuacy_SGD_8p3_argmax = np.argmax(inference_accuacy_SGD_8p3[:,:NI],axis=1)
            
inference_accuacy_SGD_8p3LB = np.load('inference_accuracy_SGD_8p3LB.npy')
inference_accuacy_SGD_8p3LB_max = np.max(inference_accuacy_SGD_8p3LB[:,:NI],axis=1)
inference_accuacy_SGD_8p3LB_argmax = np.argmax(inference_accuacy_SGD_8p3LB[:,:NI],axis=1)
            

inference_accuacy_SGD_16p6 = np.load('inference_accuracy_SGD_16p6.npy')
inference_accuacy_SGD_16p6_max = np.max(inference_accuacy_SGD_16p6[:,:NI],axis=1)
inference_accuacy_SGD_16p6_argmax = np.argmax(inference_accuacy_SGD_16p6[:,:NI],axis=1)


inference_accuacy_SGD_16p6LB = np.load('inference_accuracy_SGD_16p6LB.npy')
inference_accuacy_SGD_16p6LB_max = np.max(inference_accuacy_SGD_16p6LB[:,:NI],axis=1)
inference_accuacy_SGD_16p6LB_argmax = np.argmax(inference_accuacy_SGD_16p6LB[:,:NI],axis=1)
...
z1 = inference_accuacy_SGD_8p3_max
z2 = inference_accuacy_SGD_8p3LB_max
z3 = inference_accuacy_SGD_16p6_max
z4 = inference_accuacy_SGD_16p6LB_max
...
plt.savefig('SGD_3D_plot.pdf', bbox_inches='tight',transparent=True)
plt.show()
