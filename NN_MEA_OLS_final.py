...
np.save('l2_error_MSB_OLS_8p3.npy',l2_error_MSB_avg)
np.save('l2_error_MSBm1_OLS_8p3.npy',l2_error_MSBm1_avg)
np.save('inference_accuracy_OLS_8p3.npy',accuracy_reconstructed_unscaledflat)
np.save('mismatch_prob_OLS_8p3.npy',mismatch_prob)
...
# plt.savefig('BER_MSB_OLS_8p3.pdf',bbox_inches='tight')
...
# plt.savefig('BER_MSBm1_OLS_8p3.pdf',bbox_inches='tight')

#%%   
accuracy_reconstructed_unscaledflat = np.load('inference_accuracy_OLS_8p3.npy')
NOI_attack = 2000    
loc_idx = 0
ftsize = 15
fig, ax = plt.subplots(figsize = FIG_SIZE)
...
# plt.savefig('CIFAR-10_Acc_OLS_8p3.pdf',bbox_inches='tight')

#%%    
mismatch_prob = np.load('mismatch_prob_OLS_8p3.npy')   
loc_idx = 0
ftsize = 15
fig, ax = plt.subplots(figsize = FIG_SIZE)
ax.grid(which = 'both', alpha = GRID_ALPHA, linestyle = 'dotted')
