...
ADC_npz_codeset_v1 = np.load('May22_2024_OLSAttack_100k_10times_8p3MHz_N64_ADC65-105.npz')
...
#adc_read_codeset = copy.deepcopy(adc_read_codeset_v2)
...
np.save('l2_error_MSB_SDG_lin_8p3.npy',l2_error_MSB_avg)
np.save('l2_error_MSBm1_SDG_lin_8p3.npy',l2_error_MSBm1_avg)
np.save('inference_accuracy_SDG_lin_8p3.npy',accuracy_reconstructed_unscaledflat)
np.save('mismatch_prob_SDG_lin_8p3.npy',mismatch_prob)
...
# plt.savefig('BER_MSB_SDG_lin_8p3.pdf',bbox_inches='tight')

#%%      
l2_error_MSBm1_avg =  np.load('l2_error_MSBm1_SDG_lin_8p3.npy')
loc_idx = 0
ftsize = 15
fig, ax = plt.subplots(figsize = FIG_SIZE)
ax.grid(which = 'both', alpha = GRID_ALPHA, linestyle = 'dotted')
...
# plt.savefig('BER_MSBm1_SDG_lin_8p3.pdf',bbox_inches='tight')

#%%       
accuracy_reconstructed_unscaledflat = np.load('inference_accuracy_SDG_lin_8p3.npy')
NOI_attack = 2000   
loc_idx = 0
ftsize = 15
fig, ax = plt.subplots(figsize = FIG_SIZE)
...
# plt.savefig('CIFAR-10_Acc_SDG_lin_8p3.pdf',bbox_inches='tight')

#%%     
mismatch_prob = np.load('mismatch_prob_SDG_lin_8p3.npy')   
loc_idx = 0
ftsize = 15
fig, ax = plt.subplots(figsize = FIG_SIZE)
ax.grid(which = 'both', alpha = GRID_ALPHA, linestyle = 'dotted')
